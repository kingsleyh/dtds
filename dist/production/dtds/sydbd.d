...
//static const(void*)[] no_unused_sybdb_h_warn = [ rcsid_sybdb_h, no_unused_sybdb_h_warn];
...
alias DB_DBBUSY_FUNC = DBWAITFUNC function (void *dbproc);
...
BYTE *strtext;
DBINT strtotlen;
struct dbstring { dbstring *strnext; };
};
...
alias DBDATEREC = tds_sybase_dbdaterec;
...
// got bored !! The rest is the same as the C one
RETCODE dbsetversion(DBINT versionParam);
...
RETCODE dbsetlversion (LOGINREC * login, BYTE versionParam);
